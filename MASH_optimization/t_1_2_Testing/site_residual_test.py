...
#
site_df = site_df[site_df["Time"]<=1700]
...
np.savetxt(f"/u/dem/kebl6911/Part-II/MASH_optimization/t_1_2_Testing/final_pop_500_1700.dat",final_pop, delimiter = "\t")
np.savetxt(f"/u/dem/kebl6911/Part-II/MASH_optimization/t_1_2_Testing/500_1700.dat", residual_data,delimiter="\t")